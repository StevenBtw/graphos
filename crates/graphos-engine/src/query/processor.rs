...
use graphos_common::types::{EpochId, TxId, Value};
...
pub struct QueryProcessor {
    ...
    #[cfg(feature = "rdf")]
    rdf_store: Option<Arc<graphos_core::graph::rdf::RdfStore>>,
}
...
impl QueryProcessor {
    ...
    pub fn with_rdf(
        lpg_store: Arc<LpgStore>,
        rdf_store: Arc<graphos_core::graph::rdf::RdfStore>,
    ) -> Self {
        Self {
            lpg_store,
            tx_manager: Arc::new(TransactionManager::new()),
    ...
    #[cfg(feature = "rdf")]
    #[must_use]
    pub fn rdf_store(&self) -> Option<&Arc<graphos_core::graph::rdf::RdfStore>> {
