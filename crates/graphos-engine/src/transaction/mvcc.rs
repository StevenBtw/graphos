...
//!
//! The core MVCC types are defined in `graphos-common` and re-exported here
//! for convenience within the engine crate.

// Re-export MVCC types from graphos-common.
// Note: Version is included for completeness even if not currently used in engine.
#[allow(unused_imports)]
pub use graphos_common::mvcc::{Version, VersionChain, VersionInfo};
